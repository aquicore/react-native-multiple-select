...
import { FlatList, Text, TextInput, TouchableOpacity, TouchableWithoutFeedback, UIManager, View } from 'react-native';
...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    searchResultWrapperStyle: PropTypes.object,
  ...
  _itemStyle = item => {
    ...
    const color = isSelected
      ? { color: selectedItemTextColor, ...selectedItemStyle }
      : { color: itemTextColor };
    return {
      ...fontFamily,
      ...itemStyle,
  ...
  _selectStyle = () => this.props.selectStyle;
          ...
          <View style={styles.selectorView(fixedHeight)}>
            ...
            <View
              style={[
                ...
                this.props.searchResultWrapperStyle
              ]}
            >
